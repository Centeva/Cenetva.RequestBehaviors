...
namespace Centeva.RequestBehaviors.Tests.Mediator.FluentValidation;
...
public class FluentValidationBehaviorTests
{
    ...
    public FluentValidationBehaviorTests()
    {
        ...
        services.AddMediatorFluentValidation(typeof(FluentValidationBehaviorTests).Assembly);
    ...
    {
        public ValueTask<string> Handle(RequestWithoutValidation request, CancellationToken cancellationToken)
        {
    ...
    {
        public ValueTask<Result<string>> Handle(RequestWithGenericResult request, CancellationToken cancellationToken)
        {
    ...
    {
        public ValueTask<Result> Handle(RequestWithResult request, CancellationToken cancellationToken)
        {
    ...
    {
        public ValueTask<Result<string>> Handle(RequestWithMultipleValidators request, CancellationToken cancellationToken)
        {
            return ValueTask.FromResult(Result<string>.Success("success"));
        }
    }
    ...
    {
        public ValueTask<Result<string>> Handle(RequestWithMultipleFailures request, CancellationToken cancellationToken)
        {
            return ValueTask.FromResult(Result<string>.Success("success"));
        }
    }
    ...
    {
        public ValueTask<Result<string>> Handle(RequestWithErrorCode request, CancellationToken cancellationToken)
        {
            return ValueTask.FromResult(Result<string>.Success("success"));
        }
    }
    ...
    {
        public ValueTask<Result<string>> Handle(RequestWithConfigurableSeverity request, CancellationToken cancellationToken)
        {
            return ValueTask.FromResult(Result<string>.Success("success"));
        }
    }
