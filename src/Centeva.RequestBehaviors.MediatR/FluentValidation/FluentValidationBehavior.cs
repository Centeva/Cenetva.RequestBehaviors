...
namespace Centeva.RequestBehaviors.MediatR.FluentValidation;
...
public class FluentValidationBehavior<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse> where TRequest : class, IBaseRequest
{
